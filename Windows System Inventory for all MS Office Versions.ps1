clear
$Host.UI.RawUI.WindowTitle = "System Inventory Tool"
Write-Host `n
...
$MSOfficeVersionNO = Read-Host "Enter Version number of MS Office installed in this local machine(2013 or 2010 etc)"
[console]::ResetColor()
Write-Host `n
Write-Host "Please wait.. Creating Excel file and adding sheets in background " -ForegroundColor magenta
$excel = New-Object -ComObject excel.application
$excel.visible = $False
$workbook = $excel.Workbooks.Add()
if ($MSOfficeVersionNO -eq "2010") {
$workbook.Worksheets.Add() | Out-Null
$workbook.Worksheets.Add() | Out-Null
$workbook.Worksheets.Add() | Out-Null
}
elseif ($MSOfficeVersionNO -eq "2013") {
$workbook.Worksheets.Add() | Out-Null
$workbook.Worksheets.Add() | Out-Null
$workbook.Worksheets.Add() | Out-Null
$workbook.Worksheets.Add() | Out-Null
